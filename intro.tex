...
formation}:
\ednote{Do I really mean enthalpy?}
...
$H_2O$ and releasing $O_2$.\ednote{Give an example.}
...
condensation reaction --- yielding a phosphoester link.\ednote{Give an example} In fact, a
...
\ednote{Add more text to each molecule}
...
\]
\ednote{Double check, because the charge is not balanced}
